    ...
    render() {
        ...
        const navbar = this.props.currentUser ? (
            <nav className="homebar-right">
                <Link className="homebar-item" to="/upload">Upload</Link>
                <Link className={`homebar-item homebar-profile`} to={`/users/${this.props.currentUser.id}`}>
                    <img className="homebar-profile-pic" src={this.props.currentUser.profilePic} />
            ...
            <header className="homebar">
                <div className="homebar-container">
                    <nav className="homebar-left">
                        {navlogo}
                        <Link className="homebar-item" to="/discover">Home</Link>
                        <Link className="homebar-item" to="/stream">Stream</Link>
                    </nav>
                    {navbar}
                </div>
            </header>
